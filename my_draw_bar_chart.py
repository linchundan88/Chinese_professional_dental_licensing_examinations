...
parser.add_argument('--exam_type', default='dental_licensing_examination')  # assistant_level_dental_licensing_examination
...
plt.title('Model Performance Comparison with 95% Confidence Intervals', fontsize=14)
plt.ylim(0, 1)
